...
namespace RESOURCES::MANAGER {
    ...
    const char POWER_UP_ICON_NONE[]     = D_UI_TEXTURES "powerup_none.png";
	...
	const char AUDIO_WAV_CHECKPOINT_NEW[]			= D_AUDIO "wav/checkpoint_new.wav";
...
namespace RESOURCES::MANAGER::GLTFS {
	...
	const char* FILEPATHS[HANDLERS_COUNT] {
		...
		D_GLTFS "toriii.gltf",
		D_GLTFS "ninja.gltf", //D_GLTFS "ninjaWhite.gltf",
		D_GLTFS "create.gltf",
	};
